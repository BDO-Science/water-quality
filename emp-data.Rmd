...
* 15-minute Electrical Conductivity and Water Temperature at CLL, SAL, CNT, UNI, PCT, CCS, EMM
* 1 to 15-minute EC, WT, pH, DO, turbidity, chlorophyll a fluorescence, tidal elevation and meteorological data (air temperature, wind speed and direction, solar radiation) for DMC
...
* We are not quite collecting at the frequency specified by Table 5 for water temperature. 
...
* We could get the QA/QC protocols from Melanie's group. All we did here was basic range filtering, and not even 100% sure of appropriate EC range.
